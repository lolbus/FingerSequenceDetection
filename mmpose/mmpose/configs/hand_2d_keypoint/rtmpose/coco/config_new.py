_base_ = ['C:/Users/ASUS/Desktop/DDA_Exercise/mmpose/mmpose/configs/_base_/default_runtime.py']
...
data_mode = 'topdown'
data_root = 'C:\\Users\\ASUS\\Desktop\\DDA_Exercise\\mmpose/data/test'
...
val_coco = dict(
    ...
    data_prefix=dict(img='detection/coco/val/'),
    pipeline=[],
)
