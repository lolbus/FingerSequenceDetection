    ...
    def __init__(self,
        ...
        if pose3d is not None:
            ...
            self.inferencer = Pose2DInferencer(pose2d, pose2d_weights, device,
                                               ...
                                               det_cat_ids, show_progress=show_progress)
        else:
            raise ValueError('Either 2d or 3d pose estimation algorithm '
                             'should be provided.')

    def preprocess(self, inputs: InputsType, batch_size: int = 1, file_name=0, **kwargs):
        ...
        for i, input in enumerate(inputs):
            ...
            data_infos = self.inferencer.preprocess_single(
                input, index=i+file_name, **kwargs)
    ...
    def __call__(
        ...
        **kwargs,
        ...
        inputs = self.preprocess(
            inputs, batch_size=batch_size, file_name = file_name, **preprocess_kwargs)
